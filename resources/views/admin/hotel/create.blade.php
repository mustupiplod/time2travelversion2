    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{route('hotel.list')}}">Hotels</a></li>
                    ...
                    <form action="{{route('hotel.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6 col-md-4">
                                <label for="category_name">Hotel Name<span class="text-danger">*</span></label>
                                <input  type="text" class="form-control validate" required name="hotel_name" >
